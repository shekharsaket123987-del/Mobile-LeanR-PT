...
/** Row list + sign-out button, no outer page chrome — shared by the routed screen below and `(admin)/_layout.tsx`'s More sheet. */
export function AdminMoreContent({ onNavigate }: { onNavigate?: (href: string) => void }) {
