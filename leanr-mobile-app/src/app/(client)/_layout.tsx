...
import { ClientMoreContent } from './more';
      ...
      <>
        ...
        >
          ...
          <Tabs.Screen
            ...
            options={{
              title: 'Plans',
              tabBarIcon: ({ focused, color }) => <TabIcon name={focused ? 'pricetag' : 'pricetag-outline'} color={color} />,
            }}
          />
          <Tabs.Screen
            name="reviews"
            options={{
              title: 'Reviews',
              tabBarIcon: ({ focused, color }) => <TabIcon name={focused ? 'star' : 'star-outline'} color={color} />,
            }}
          />
          <Tabs.Screen
            name="more"
